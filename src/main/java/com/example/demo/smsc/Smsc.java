...
public class Smsc {
    ...
    String SMSC_LOGIN    = "sayrambayeldar12@gmail.com";     // логин клиента
    String SMSC_PASSWORD = "cd5d0d2cc4b174e033b4ca52c9bd93cd6a6bfcd4";  // пароль
...
/*
		Smsc sd= new Smsc();
		// or
		Smsc sd= new Smsc("login", "cd5d0d2cc4b174e033b4ca52c9bd93cd6a6bfcd4");
